...
public enum OctahedralGroup implements StringRepresentable
{
    ...
    private OctahedralGroup(String string2, SymmetricGroup3 symmetricGroup3, boolean bl, boolean bl2, boolean bl3) {
        ...
        this.transformation.mul((Matrix3fc)symmetricGroup3.transformation());
    }
    ...
    public Direction rotate(Direction direction) {
        if (this.rotatedDirections == null) {
            ...
            Direction.Axis[] axisArray = Direction.Axis.values();
            for (Direction direction2 : Direction.values()) {
                Direction.Axis axis = direction2.getAxis();
                Direction.AxisDirection axisDirection = direction2.getAxisDirection();
                Direction.Axis axis2 = axisArray[this.permutation.permutation(axis.ordinal())];
    ...
    static {
        cayleyTable = Util.make(new OctahedralGroup[OctahedralGroup.values().length][OctahedralGroup.values().length], octahedralGroupArray -> {
