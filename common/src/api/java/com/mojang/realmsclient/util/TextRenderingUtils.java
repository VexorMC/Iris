...
public class TextRenderingUtils {
    ...
    public static List<Line> decompose(String string, LineSegment ... lineSegmentArray) {
        return TextRenderingUtils.decompose(string, Arrays.asList(lineSegmentArray));
    }
    ...
    public static class Line {
        ...
        Line(LineSegment ... lineSegmentArray) {
            this(Arrays.asList(lineSegmentArray));
        }
